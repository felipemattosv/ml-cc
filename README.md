...
A good way to develop some intuition about backprop is visiting [Backpropagation algorithm visual explanation](https://developers-dot-devsite-v2-prod.appspot.com/machine-learning/crash-course/backprop-scroll?hl=pt-br)

### Multi-Class Neural Networks
Instead of applying a threshold to a Logistic regressor to pick a binary classification, we can use multi-class neural networks to pick from multiple possibilities of classes.

#### One-Vs-All Multi-Class
Training on a signal "my class" vs "all other classes". Can be done using a deep network or with separate Logistic regression models.

#### SoftMax Multi-Class
- Used when we have a Multi-Class Single-Label Classification problem.
